import gpiozero
import time
sensorFront_Right = gpiozero.DistanceSensor(echo=19,trigger=16, max_distance=2,queue_len=15)
sensorLeft = gpiozero.DistanceSensor(echo=11,trigger=20, max_distance=2,queue_len=15)
